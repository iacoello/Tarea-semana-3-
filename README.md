...
Analizar lo conceptos relacionados a los circuitos en serie y en paraleo correspondientemente con los metodos de mmallas y nodos aplicables a la electronica fundamental, relacionando estos conocimientos con los previamente adquiridos en las unidades anteriores.
...
Desarrollar el conocimiento refernete a la ley de de Ohm y las medidas de corriente, voltaje y resistencia que esta requiere. 

Aplicar la dinamica de circuitos para la resolucion de ejercicios relacionados a cargas y potencia asi como analisis de fallas. 
...
43. Si en el problema 40 se funde uno de los focos, ¿cuánta corriente circulará a través de cada foco restante? ¿Cuál será la corriente total
...
<img src="https://latex.codecogs.com/svg.image?\\Conectar~el~ohmmetro~entre~las~siguientes~clavijas:\\Clavijas&space;1-2\\Lectura&space;correcta:&space;\\R=&space;1.0K\mho&space;\left|&space;\right|&space;3.3k\mho&space;=&space;159.5\mho\\Lectura&space;correcta:\\R1=abierto:3.3k\mho&space;\\R2=abierto:1.0k\mho&space;" title="\\Conectar~el~ohmmetro~entre~las~siguientes~clavijas:\\Clavijas 1-2\\Lectura correcta: \\R= 1.0K\mho \left| \right| 3.3k\mho = 159.5\mho\\Lectura correcta:\\R1=abierto:3.3k\mho \\R2=abierto:1.0k\mho " />
...
<img src="https://latex.codecogs.com/svg.image?~\\\bigl(\begin{smallmatrix}a\end{smallmatrix}\bigr)~1y~2\\No~existe~contacto\\\bigl(\begin{smallmatrix}b\end{smallmatrix}\bigr)~2y~3\\&space;Req=&space;\frac{1}{\frac{1}{R5}&plus;\frac{1}{R6}&plus;\frac{1}{R7}&plus;\frac{1}{R8}&plus;\frac{1}{R9}&plus;\frac{1}{R10}}\\\bigl(\begin{smallmatrix}c\end{smallmatrix}\bigr)~2y~4\\No~existe~contacto\\\bigl(\begin{smallmatrix}d\end{smallmatrix}\bigr)~1y~4\\&space;Req=&space;\frac{1}{\frac{1}{R1}&plus;\frac{1}{R2}&plus;\frac{1}{R3}&plus;\frac{1}{R}&plus;\frac{1}{R9}&plus;\frac{1}{R10}}&space;" title="~\\\bigl(\begin{smallmatrix}a\end{smallmatrix}\bigr)~1y~2\\No~existe~contacto\\\bigl(\begin{smallmatrix}b\end{smallmatrix}\bigr)~2y~3\\ Req= \frac{1}{\frac{1}{R5}+\frac{1}{R6}+\frac{1}{R7}+\frac{1}{R8}+\frac{1}{R9}+\frac{1}{R10}}\\\bigl(\begin{smallmatrix}c\end{smallmatrix}\bigr)~2y~4\\No~existe~contacto\\\bigl(\begin{smallmatrix}d\end{smallmatrix}\bigr)~1y~4\\ Req= \frac{1}{\frac{1}{R1}+\frac{1}{R2}+\frac{1}{R3}+\frac{1}{R}+\frac{1}{R9}+\frac{1}{R10}} " />
