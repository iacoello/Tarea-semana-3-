...
<img src="https://latex.codecogs.com/svg.image?~\\\bigl(\begin{smallmatrix}a\end{smallmatrix}\bigr)~1y~2\\No~existe~contacto\\\bigl(\begin{smallmatrix}b\end{smallmatrix}\bigr)~2y~3\\&space;Req=&space;\frac{1}{\frac{1}{R5}&plus;\frac{1}{R6}&plus;\frac{1}{R7}&plus;\frac{1}{R8}&plus;\frac{1}{R9}&plus;\frac{1}{R10}}\\\bigl(\begin{smallmatrix}\\\bigl(\begin{smallmatrix}c\end{smallmatrix}\bigr)~2y~4\\No~existe~contactod\end{smallmatrix}\bigr)~1y~4\\&space;Req=&space;\frac{1}{\frac{1}{R1}&plus;\frac{1}{R2}&plus;\frac{1}{R3}&plus;\frac{1}{R4}&plus;\frac{1}{R11}&plus;\frac{1}{R12}}&space;" title="~\\\bigl(\begin{smallmatrix}a\end{smallmatrix}\bigr)~1y~2\\No~existe~contacto\\\bigl(\begin{smallmatrix}b\end{smallmatrix}\bigr)~2y~3\\ Req= \frac{1}{\frac{1}{R5}+\frac{1}{R6}+\frac{1}{R7}+\frac{1}{R8}+\frac{1}{R9}+\frac{1}{R10}}\\\bigl(\begin{smallmatrix}\\\bigl(\begin{smallmatrix}c\end{smallmatrix}\bigr)~2y~4\\No~existe~contactod\end{smallmatrix}\bigr)~1y~4\\ Req= \frac{1}{\frac{1}{R1}+\frac{1}{R2}+\frac{1}{R3}+\frac{1}{R4}+\frac{1}{R11}+\frac{1}{R12}} " />
